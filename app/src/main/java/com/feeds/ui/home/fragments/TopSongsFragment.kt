...
import kotlinx.android.synthetic.main.fragment_top_songs.progressBar
import kotlinx.android.synthetic.main.fragment_top_songs.rvSongs
import kotlinx.android.synthetic.main.fragment_top_songs.swipeRefresh
...
class TopSongsFragment : Fragment(),SwipeRefreshLayout.OnRefreshListener {
    ...
    private fun getTopSongs() {
        ...
        val call = ApiClient.create().getTopSongs()
